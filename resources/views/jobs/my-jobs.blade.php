                    ...
                    <div class="card-body card-form">
                        <div class="d-flex justify-content-between">
                            ...
                            <div style="margin-top: -10px;">
                                <a href="{{ route('user.createJob') }}" class="btn btn-primary">Post a Job</a>
                            </div>
                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a class="dropdown-item" href="{{ route('user.editJobs', $job->id) }}"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a></li>
